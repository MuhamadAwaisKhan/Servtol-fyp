                          ...
                          StreamBuilder<QuerySnapshot>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return ListView.builder(
                                ...
                                physics: NeverScrollableScrollPhysics(), // Prevents scrolling within the list
                                shrinkWrap: true, // Ensures the list does not expand unnecessarily
                                    ...
                                    builder: (context, customerSnapshot) {
                                      ...
                                      return Card(
                                        ...
                                        child: ListTile(
                                          ...
                                          trailing: Row(
                                            mainAxisSize: MainAxisSize.min, // This ensures the trailing widgets fit
                                            children: [
                                              Icon(FontAwesomeIcons.solidStar, size: 13, color: Colors.amber),
                                              SizedBox(width: 3),
                                              Text(
